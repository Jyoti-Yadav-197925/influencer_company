    ...
    <div className="w-full max-w-sm bg-white shadow-lg rounded-lg p-4">
      ...
      <div className="border-t pt-4 flex justify-between items-center">
        ...
        <div className="flex space-x-4 justify-between ">
              <button className="text-green-500 border border-green-500 p-2 rounded-xl justify-center">
                ✔️
              </button>
              <button className="text-red-500 border border-red-500 p-2 rounded-xl justify-center">
                ❌
              </button>
            
              
            </div>
            <span className="h-5 w-5 mt-4  ">
                <FaAngleRight />
              </span>
          </div>
